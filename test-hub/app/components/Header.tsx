...
export default function Header() {
  ...
  return (
    <header className="flex items-center justify-between px-6 py-3 bg-white dark:bg-[#0a0a0a] border-b border-gray-100 dark:border-gray-900 sticky top-0 z-50 transition-colors duration-300">
      ...
      <Link 
        href="/" 
        className="text-lg font-bold tracking-tight text-black dark:text-white transition-opacity duration-200 hover:opacity-50 select-none cursor-pointer"
      >
        LABGG.PRO
      </Link>
      ...
      <div className="flex items-center gap-5 sm:gap-6">
        ...
        {/* 디스코드 아이콘 */}
        <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 dark:text-gray-400 transition-colors duration-200 hover:text-black dark:hover:text-white" aria-label="Discord">
        ...
        {/* 인스타그램 아이콘 */}
        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 dark:text-gray-400 transition-colors duration-200 hover:text-black dark:hover:text-white" aria-label="Instagram">
        ...
        >
          <svg
            ...
            className={`absolute text-gray-500 dark:text-gray-400 group-hover:text-black dark:group-hover:text-white transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] ${
